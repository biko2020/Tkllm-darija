...
#
# Staging environment: mirrors production but with moderate resource sizes.
#
# Key staging differences vs prod:
#   - Medium instance sizes (t3.large, db.t4g.medium, etc.)
#   - 2–3 AZs, multi-AZ RDS, moderate scaling
#   - No deletion protection on RDS
#   - CloudWatch log retention: 30 days
#   - DNS subdomains prefixed with staging.
#
# Apply:
...
#
# Destroy:
#   bash ../../../../infrastructure/scripts/destroy.sh staging
# =============================================================================
...
locals {
	environment = "staging"
	name_prefix = "tkllm-darija-staging"
